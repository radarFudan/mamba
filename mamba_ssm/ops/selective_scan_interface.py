...
# from mamba_own.mamba_ssm.ops.associative_scan import associative_scan
...
def selective_scan_ref(u, delta, A, B, C, D=None, z=None, delta_bias=None, delta_softplus=False,
    ...
    # set the value of x to be the same as cache_ssm_state
    # print("x.shape: ", x.shape)
    # print("cache_ssm_state.shape: ", cache_ssm_state.shape)
    assert x.shape == cache_ssm_state.shape
